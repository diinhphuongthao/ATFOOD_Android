...
function List_Food_NVPV({navigation, route}) {
  const { EmailStaff } = route.params;
  const { EStaff } = route.params;
  console.log("EmailStaff:" + EmailStaff)
  console.log("EStaff:" + EStaff)
  return (
    <View style={{ backgroundColor: '#F0F0DD', height: '100%' }}>
      ...
      <View style={{ flexDirection: 'row', }}>
        <View style={{ paddingTop: 15, marginLeft: 15 }}>
          ...
          }} onPress={() => navigation.navigate('Home_NVPV', { Staff: EStaff })}>
            <Image style={{
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={{ paddingTop: 180, flexDirection: 'row' }}>
          ...
          <View style={{ marginRight: 10 }}>
            <View>
              <TouchableOpacity onPress={() => navigation.navigate('Meat_List_NVPV', { Staff: EmailStaff || EStaff })} style={{
            ...
            <View style={{ paddingTop: 20 }}>
              <TouchableOpacity onPress={() => navigation.navigate('Fish_List_NVPV', { Staff: EmailStaff || EStaff })} style={{
                width: 160, height: 100, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center'
                , borderRadius: 20
                , borderWidth: 1
                ,
          ...
          <View style={{ marginLeft: 10 }}>
            <View style={{}}>
              <TouchableOpacity onPress={() => navigation.navigate('Soup_List_NVPV', { Staff: EmailStaff || EStaff })} style={{
                width: 160, height: 100, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center'
                , borderRadius: 20
                , borderWidth: 1
                ,
            ...
            <View style={{ paddingTop: 20 }}>
              <TouchableOpacity onPress={() => navigation.navigate('Drink_List_NVPV', { Staff: EmailStaff || EStaff })} style={{
                width: 160, height: 100, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center'
                , borderRadius: 20
                , borderWidth: 1
                ,
